...
function moreButtons(){
    if(temp[0] == "a"){
        //<button id="moveBackBtn" class="circleBtn" onclick="moveForward();"><i class="material-icons">east</i></button>
        //<button id="moveForBtn" class="circleBtn" onclick="moveBackward();"><i class="material-icons">west</i></button>
