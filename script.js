...
function moreButtons(){
    if(temp[0] == "a"){
        document.getElementById("buttonWrapper").innerHTML = '<button class="redBtn" onclick="cancelWord();"><i class="material-icons">cancel</i></button><button class="plusAfter" onclick="addForward();"><i class="material-icons">east</i></button><button id="moveBackBtn" class="" onclick="moveForward();"><i class="material-icons">east</i></button><button class="muteBtn largerMute"><i class="material-icons">volume_up</i></button><button id="moveForBtn" class="" onclick="moveBackward();"><i class="material-icons">west</i></button><button class="plusBefore" onclick="addBackward();"><i class="material-icons">west</i></button><button class="greenBtn" onclick="approveWord();"><i class="material-icons">check_circle</i></button>';
    }else{
        document.getElementById("buttonWrapper").innerHTML = '<button class="redBtn" onclick="cancelWord();"><i class="material-icons">cancel</i></button><button class="plusAfter" onclick="addBackward();"><i class="material-icons">east</i></button><button id="moveBackBtn" class="" onclick="moveBackward();"><i class="material-icons">east</i></button><button class="muteBtn largerMute"><i class="material-icons">volume_up</i></button><button id="moveForBtn" class="" onclick="moveForward();"><i class="material-icons">west</i></button><button class="plusBefore" onclick="addForward();"><i class="material-icons">west</i></button><button class="greenBtn" onclick="approveWord();"><i class="material-icons">check_circle</i></button>';
    }
}
